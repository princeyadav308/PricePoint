            ...
            <div className="relative w-full max-w-md p-8 bg-background-light dark:bg-background-dark rounded-3xl outer-shadow-lg mx-auto border border-white/20 dark:border-white/5">
                ...
                {isSignUpSuccess ? (
                    <div className="text-center py-4 animate-fade-in">
                        <div className="w-16 h-16 mx-auto bg-background-light dark:bg-background-dark rounded-full inner-shadow flex items-center justify-center mb-6">
                        ...
                        <p className="text-slate-500 mb-8 leading-relaxed">
                            We've sent an activation link to <br /><span className="font-medium text-text-light dark:text-text-dark">{email}</span>.<br /><br />Please verify your email to access the platform.
                        </p>
                        <button
                            onClick={onClose}
                            className="w-full py-4 bg-background-light dark:bg-background-dark text-text-light dark:text-text-dark font-semibold rounded-2xl outer-shadow hover-in-shadow active:active-pressed transition-all"
                        >
                            Return to Website
                        </button>
                    </div>
