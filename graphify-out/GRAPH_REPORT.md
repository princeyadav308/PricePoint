...
## Corpus Check
- 89 files · ~78,597 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 677 nodes · 921 edges · 51 communities (40 shown, 11 thin omitted)
...
Cohesion: 0.05
Nodes (36): autoprefixer, devDependencies, autoprefixer, eslint, eslint-plugin-react-hooks, eslint-plugin-react-refresh, postcss, tailwindcss (+28 more)
...
Cohesion: 0.07
Nodes (27): dependencies, dagre, lucide-react, react, react-dom, @react-pdf/renderer, react-router-dom, reactflow (+19 more)
...
Cohesion: 0.12
Nodes (19): AuthModal(), AuthModalProps, Header(), HeaderProps, MANDATORY_CATEGORIES, ResultNode, ResultNodeData, GENERATION_STEPS (+11 more)
...
Cohesion: 0.40
Nodes (4): Phase 5.5 — Report Integrity Overhaul ✅, Phase 6 — Crawl4AI Migration ✅, Phase 7 — UX Polish: Report Generation Sequence 🚀 (In Progress), PricePoint Master Roadmap & Checklist
...
- **Why does `Logger` connect `Intelligence Routes` to `Server API Routes`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `useSessionStore` connect `Client App and Shell` to `Pricing Engine & Layout`, `ResultNode.tsx`, `currency.ts`, `QuestionNode.tsx`?**
